...
```
# curl -L http://javalanche.net/install.sh | bash
```

For Developers, see the following to build javalanche from your development branch
```
# curl -L -o install.sh http://javalanche.net/install.sh
...
To connect to the C2 Server as a red team operator, a pre-built Command Line Interface is provided.
